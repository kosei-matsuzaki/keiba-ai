...
Usage:
    uv run python -m jobs.fetch_live_odds --race-id 202506050911
    uv run python -m jobs.fetch_live_odds --race-ids 202506050911,202506050912
    uv run python -m jobs.fetch_live_odds --race-id 202506050911 --types b1,b4,b5
