...
describe('RecommendationsCard', () => {
  ...
  it('null ev rows sort after rows with ev values', () => {
    const dataWithMixed: RecommendationsResponse = {
      ...
      odds_source: 'past',
      candidates: [
        { bet_type: '馬連', combo: '1-3', pattern: 'box', confidence: 0.2, est_odds: null, ev: null, stake: 0, post_positions: [1, 3] },
        { bet_type: '単勝', combo: '3', pattern: 'box', confidence: 0.35, est_odds: 3.0, ev: 1.05, stake: 300, post_positions: [3] },
      ],
    };
      ...
      candidates: [
        {
          ...
          pattern: 'box',
          confidence: 0.4,
          probability_model_confidence: 0.31,
          est_odds: 10,
          ev: 4.0,
          stake: 500,
          post_positions: [1],
        },
        {
          ...
          pattern: 'box',
          confidence: 0.7,
          probability_model_confidence: 0.68,
          est_odds: 1.5,
          ev: 1.05,
          stake: 900,
          post_positions: [1],
